...
function* promisified() {
  yield readFile(__filename, 'utf-8')
...
function* generatorTesteFn() {
  const result = yield 'caique'
  yield ''
  yield result
  yield result
}

const generatorTeste = generatorTesteFn()
console.log(generatorTeste.next(''))
console.log(generatorTeste.next('moraes'))
console.log(generatorTeste.next(''))
console.log(generatorTeste.next())
console.log(generatorTeste.next())
