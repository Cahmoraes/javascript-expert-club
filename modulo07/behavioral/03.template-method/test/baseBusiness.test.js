...
describe('#BaseBusiness', () => {
  ...
  test('should throw an error when child class doest implement _validateRequiredFields function', () => {
  ...
  test('should throw an error when child class doest implement _create function', () => {
    const CREATE_SUCCEEDED = true

    class ConcreteClass extends BaseBusiness {
      _validateRequiredFields = jest.fn().mockReturnValue(CREATE_SUCCEEDED)
    }
    const concreteClass = new ConcreteClass()
